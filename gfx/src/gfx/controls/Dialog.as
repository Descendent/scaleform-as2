...
*/
intrinsic class gfx.controls.Dialog extends UIComponent
{
	/** A reference to the current, open dialog. */
	static public var currentDialog : MovieClip;
	/** Determines if there is a currently open dialog. */
	static public var open : Boolean;
	private var _bSetup : Boolean;
	 ...
	 * @see PopUpManager
	 */
	static public function show(context:MovieClip, linkage:String, props:Object, modal:Boolean) : MovieClip;
	...
	static private function closeDialog(event:Object) : Void;

	static private function blockInteraction() : Void;
